...
! function (t) {
    ...
    ! function () {
        ...
        "function" == typeof t && "mixitup-extension" === t.TYPE ? "undefined" == typeof e.extensions[t.NAME] && (t(e), e.extensions[t.NAME] = t) : t.fn && t.fn.jquery && (e.libraries.$ = t, e.registerJqPlugin(t))
        ...
        compareVersions: function (t, e) {
            ...
            for (r = 0; r < n.length; r++) {
                if (i = parseInt(n[r]), o = parseInt(a[r] || 0), o < i) return !1;
                if (o > i) return !0
            }
            return !0
        },
        ...
        e.Base.call(this), this.callActions("beforeConstruct"), this.target = ".mix", this.callActions("afterConstruct"), n.seal(this)
        ...
        handleClick: function (t) {
            var a = this,
                ...
                u = [],
                f = -1;
            if (this.callActions("beforeHandleClick", arguments), this.pending = 0, i = a.selector ? n.closestParent(t.target, a.selector, !0, a.bound[0].dom.document) : a.el, !i) return void a.callActions("afterHandleClick", arguments);
            switch (a.type) {
                case "filter":
        ...
        getInitialState: function () {
            var t = this,
                n = new e.State,
                a = new e.Operation;
            if (t.callActions("beforeGetInitialState", arguments), t.config.load.dataset) {
                if (!t.config.data.uidKey || "string" != typeof t.config.data.uidKey) throw new TypeError(e.messages.errorConfigDataUidKeyNotSet());
                a.startDataset = a.newDataset = n.activeDataset = t.config.load.dataset.slice(), a.show = t.targets.slice(), n = t.callFilters("stateGetInitialState", n, arguments)
            } else n.activeFilter = t.parseFilterArgs([t.config.load.filter]).command, n.activeSort = t.parseSortArgs([t.config.load.sort]).command, n.activeContainerClassName = t.config.layout.containerClassName, n.totalTargets = t.targets.length, n = t.callFilters("stateGetInitialState", n, arguments), n.activeSort.collection || n.activeSort.attribute || "random" === n.activeSort.order || "desc" === n.activeSort.order ? (a.newSort = n.activeSort, t.sortOperation(a), t.printSort(!1, a), t.targets = a.newOrder) : a.startOrder = a.newOrder = t.targets, a.startFilter = a.newFilter = n.activeFilter, a.startSort = a.newSort = n.activeSort, "all" === a.newFilter.selector ? a.newFilter.selector = t.config.selectors.target : "none" === a.newFilter.selector && (a.newFilter.selector = "");
        ...
        initControls: function () {
            ...
            for (l = 0; n = e.controlDefinitions[l]; l++)
                if (t.config.controls.live || n.live) {
                    ...
                    for (a = o.querySelectorAll(n.selector), c = 0; i = a[c]; c++) s = t.getControl(i, n.type, ""), s && t.controls.push(s);
        ...
        cleanUp: function (t) {
            ...
            if (t.willSort && (a.printSort(!1, t), a.targets = t.newOrder), a.dom.parent.style[e.features.transitionProp] = a.dom.parent.style.height = a.dom.parent.style.width = a.dom.parent.style[e.features.perspectiveProp] = a.dom.parent.style[e.features.perspectiveOriginProp] = "", t.willChangeLayout && (n.removeClass(a.dom.container, t.startContainerClassName), n.addClass(a.dom.container, t.newContainerClassName)), t.toRemove.length) {
                for (l = 0; i = a.targets[l]; l++) t.toRemove.indexOf(i) > -1 && ((o = i.dom.el.previousSibling) && "#text" === o.nodeName && (r = i.dom.el.nextSibling) && "#text" === r.nodeName && n.removeWhitespace(o), a.dom.parent.removeChild(i.dom.el), a.targets.splice(l, 1), i.isInDom = !1, l--);
                a.origOrder = a.targets
            }
            a.state = t.newState, a.lastOperation = t, a.dom.targets = a.state.targets, e.events.fire("mixEnd", a.dom.container, {
                state: a.state,
                instance: a
        ...
        diffDatasets: function (t) {
            ...
            for (a.callActions("beforeDiffDatasets", arguments), d = 0; r = t.newDataset[d]; d++) {
                if ("undefined" == typeof (h = r[a.config.data.uidKey]) || h.toString().length < 1) throw new TypeError(e.messages.errorDatasetInvalidUidKey({
                    uidKey: a.config.data.uidKey
                }));
                if (f[h]) throw new Error(e.messages.errorDatasetDuplicateUid({
                    uid: h
                }));
                f[h] = !0, (s = a.cache[h]) instanceof e.Target ? (a.config.data.dirtyCheck && !n.deepEquals(r, s.data) && (l = a.renderTarget(r), s.data = r, a.dom.parent.replaceChild(l, s.dom.el), s.dom.el = l), l = s.dom.el) : (l = l = a.renderTarget(r), s = new e.Target, s.init(l, a, r)), s.isInDom ? (u = s.dom.el.nextElementSibling, o.push(h), c && (c.lastElementChild && c.appendChild(a.dom.document.createTextNode(" ")), a.dom.parent.insertBefore(c, s.dom.el), c = null)) : (c || (c = a.dom.document.createDocumentFragment()),
                    c.lastElementChild && c.appendChild(a.dom.document.createTextNode(" ")), c.appendChild(l), s.isInDom = !0, t.toShow.push(s)), t.show.push(s)
            }
            for (c && (u = u || a.config.layout.siblingAfter, u && c.appendChild(a.dom.document.createTextNode(" ")), a.dom.parent.insertBefore(c, u)), d = 0; r = t.startDataset[d]; d++) h = r[a.config.data.uidKey], s = a.cache[h], t.show.indexOf(s) < 0 ? (t.hide.push(s), t.toHide.push(s), t.toRemove.push(s)) : i.push(h);
        ...
        renderTarget: function (t) {
            var n = this,
                ...
                r = "";
            if (n.callActions("beforeRenderTarget", arguments), "function" != typeof (a = n.config.render.target)) throw new TypeError(e.messages.errorDatasetRendererNotSet());
            return r = a(t), o.innerHTML = r, i = o.firstElementChild, n.callFilters("elRenderTarget", i, arguments)
        },
        ...
        dataset: function () {
            var t = this,
                ...
                i = null,
                o = !1;
            return t.callActions("beforeDataset", arguments), t.isBusy ? (i = new e.QueueItem, i.args = arguments, i.instruction = n, t.queueMix(i)) : (n.callback && (t.userCallback = n.callback), o = n.animate ^ t.config.animation.enable ? n.animate : t.config.animation.enable, t.goMix(o, a))
        },
        multimix: function () {
            var t = this,
                n = null,
        ...
        init: function (t, n, a) {
            var i = this,
                o = "";
            if (i.callActions("beforeInit", arguments), i.mixer = n, i.cacheDom(t), i.bindEvents(), "none" !== i.dom.el.style.display && (i.isShown = !0), a && n.config.data.uidKey) {
        ...
        return e
    }) : "undefined" != typeof t.mixitup && "function" == typeof t.mixitup || (t.mixitup = t.mixItUp = e), (a = t.$ || t.jQuery) && a.fn.jquery && e.registerJqPlugin(a), e.NAME = "mixitup", e.CORE_VERSION = "3.0.0"
}(window);